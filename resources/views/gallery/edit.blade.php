...
<div class="row">
  ...
  <div>
    ...
    @endif
      <form  method="post" action="{{ route('galery.update')}}" enctype="multipart/form-data">
            @csrf
            ...
            <input type="hidden" class="form-control" name="id" id="id" placeholder="Image Title" value={{ $image->id }}  >
            <div class="form-group">
                <label for="title">Image Title</label>
                <input class="form-control" name="title" id="title" placeholder="Image Title" value={{ $image->title }} required >
            </div>
            <div class="form-group">
                <input  type="file" class="form-control" name="images" placeholder="Upload" value={{ $image->image }} >
            </div>
